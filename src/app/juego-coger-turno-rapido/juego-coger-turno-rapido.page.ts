...
export class JuegoCogerTurnoRapidoPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.listaOpciones = this.juegoSeleccionado.Turnos.filter(
      (opcion) => opcion.persona === undefined && opcion.dia !== "*",
    );
    ...
    this.comServer.EsperoTurnosCogidos().subscribe((turno) => {
      console.log("han cogido turno");
      console.log(turno);
      this.listaOpciones = this.listaOpciones.filter(
        (opcion) => opcion.dia !== turno.dia || opcion.hora !== turno.hora,
      );
    });
    this.comServer.EsperoTurnosNuevos().subscribe((turno) => {
                ...
                buttons: [
                  {
                    ...
                    role: "cancel",
                    handler: () => {
                      this.comServer.DesconectarJuegoCogerTurnoRapido(
                        this.juegoSeleccionado.Clave,
                      );
