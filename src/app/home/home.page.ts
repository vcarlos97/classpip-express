...
export class HomePage {
  ...
  AutentificarJuegoRapido() {
    ...
    this.peticionesAPI
      .DameJuegoDeEncuestaRapida(this.clave)
      .subscribe((juego) => {
        if (juego[0] !== undefined) {
          ...
          this.peticionesAPI
            .DameJuegoDeVotacionRapida(this.clave)
            .subscribe(async (juego) => {
              if (juego[0] !== undefined) {
                ...
                this.peticionesAPI
                  .DameJuegoDeCuestionarioRapido(this.clave)
                  .subscribe(async (juego) => {
                    if (juego[0] !== undefined) {
                      console.log("Ya tengo el juego");
                      console.log(juego[0]);
                      ...
                      this.peticionesAPI
                        .DameJuegoDeCogerTurnoRapido(this.clave)
                        .subscribe(async (juego) => {
                          if (juego[0] !== undefined) {
                            console.log("Ya tengo el juego");
                            console.log(juego[0]);
                            ...
                            this.comServer.EnviarNickYRegistrar(
                              juego[0].profesorId,
                              this.nickname,
                              this.clave,
                            );
                            ...
                            const alert = await this.alertController.create({
                              ...
                              // subHeader: 'Subtitle',
                              message:
                                "No existe ningun juego rápido con esa clave",
                              buttons: ["OK"],
                            });
                            await alert.present();
                            this.clave = undefined;
